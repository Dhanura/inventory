        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
					...
					<div class="col-sm-6">
						<a href="add_order.php" class="btn btn-success" role="button"><i class="material-icons">&#xE147;</i> <span>Add New Order</span></a>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                  ...
                  echo(in_array("Admin",$result["user_role"]));
                  // Check connection
                  if($link === false){
		...
		<div class="modal-dialog">
			<div class="modal-content">
              ...
              <div class="form-group">
          		...
          		<div class="form-group">
          			<label>Item ID</label>
          			<input type="text" class="form-control" name="order_id" placeholder="I-002" required="required" disabled>
          		</div>
          				<div class="form-group">
          			       <div class="row">
          				           <div class="col-xs-12">
                               <input type="text" class="form-control" name="item_name" placeholder="Item Name" required="required"></div>
                  ...
                  <div class="form-group">
                  	<input type="number" class="form-control" name="quantity" placeholder="Quanity" required="required">
          				...
          				<div class="form-group">
                  	<input type="number" class="form-control" name="unit_price" placeholder="Unit Price(LKR)" required="required">
                  </div>
          				<div class="form-group">
                  	<input type="number" class="form-control" name="total_price" placeholder="Total Price(LKR)" required="required">
                  </div>
          				<div class="form-group">
          					<label>Date</label>
