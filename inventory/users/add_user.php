...
<div class="signup-form">
    <form action="user_add.php" method="post">
		<h2>Add User</h2>
		<p class="hint-text">Add users for departments</p>
        ...
        <div class="form-group">
            <input type="text" class="form-control" name="department_id" placeholder="Department_ID" required="required">
        </div>
        <div class="form-group">
            <input list="depertments" class="form-control" name="department_name" placeholder="Department_Name" required="required">
              <datalist id="depertments">
				...
				<div class="form-group">
            <input list="user_role" class="form-control" name="user_role" placeholder="User Role" required="required">
              <datalist id="user_role">
                <option value="Admin">
                <option value="Inventory Handler">
                <option value="Department User">
              </datalist>
        </div>
        <!-- <div class="form-group">
		...
		<div class="form-group">
            <button type="submit" class="btn btn-success btn-lg btn-block" name="user_add">Create user</button>
        </div>
    </form>
